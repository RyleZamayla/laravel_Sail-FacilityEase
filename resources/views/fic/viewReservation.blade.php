                                    ...
                                    @if ($reservation->reason)
                                        ...
                                        <div class="pl-5">
                                            @if (count($remarksDocuments) > 0)
                                                <ul>
                                                    @foreach ($remarksDocuments as $remarks)
                                                        <li class="mt-3">
                                                            <a href="{{ asset('storage/' . $remarks->remarksFiles) }}" target="_blank"
                                                                class="flex flex-row">
                                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                                    class="mr-3 w-6 h-6">
                                                    ...
                                                    <div class="flex-grow">
                                                        ...
                                                        <div class="mt-2 rounded p-2">
                                                            <div class="form-group">
                                                                <input type="file" name="remarksFiles[]" class="form-control" multiple>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="mt-10 px-3">
